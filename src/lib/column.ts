...
export const posts: BlogPost[] = [
  {
    ...
    description:
      "データ移行の手順、優先順位のつけ方、よくあるトラブルと対処法まで。Excel管理から賃貸管理ソフトへの移行をスムーズに進める方法を解説します。",
    date: "2026-03-09",
    category: "導入ガイド",
    content: `
## 移行は「一括」だけじゃない
...
いきなり全データを移行しない。1物件・数部屋だけ登録してみて、日常業務の流れ（入金確認、修繕依頼の受付など）が回るか確かめる。ここで「やっぱり合わない」となっても痛手ゼロ。
...
`,
  ...
  {
    slug: "noise-complaint-landlord-response",
    title: "入居者の騒音苦情、大家はどこまで対応すべきか",
    description:
      "「上の階の足音がうるさい」——騒音苦情は賃貸管理で最も多いトラブルのひとつ。対応の本質は防音工事ではなく、記録と報告にあります。",
    date: "2026-03-11",
    category: "苦情・トラブル対応",
    content: `
## 夜10時、電話が鳴る
...
管理会社や大家にとって、このフレーズは何度聞いたか分からないくらい定番の苦情です。騒音苦情は賃貸トラブルの中で最も多く、国土交通省の「賃貸住宅トラブル相談件数」でも毎年上位に入り続けています。

とりあえず掲示板に「深夜の騒音にご注意ください」と貼り紙をする。しばらく静まる。でも1ヶ月後、また同じ人から電話が来る。
...
これを省略して「なんかうるさいらしい」で動くと、後のステップ全てがぼやけます。加害側に注意するにしても「何月何日の何時頃、ドンドンという足音が30分以上続いたと報告がある」と伝えるのと「ちょっと音に気をつけてください」と伝えるのでは、受け取り方がまるで違います。
...
実は、加害側に自覚がないケースがほとんどです。普通に歩いているだけなのに下に響いている。子供が走り回っているのを止められない。洗濯機の振動が構造体を伝わっている——悪意がないからこそ、頭ごなしの注意は逆効果です。

### ステップ3：被害側に「動いている」ことを伝える

ここが最も見落とされるステップです。

加害側に注意した。それを被害側に報告しない管理会社が驚くほど多い。被害側からすると、「電話してから何も連絡がない。やっぱり何もしてくれなかった」と感じます。
...
つまり、大家・管理会社に求められるのは「騒音をゼロにすること」ではなく、**「苦情に対して適切に対応すること」**です。
...
**退去時の対応**——「騒音で退去を余儀なくされた」と主張された場合、管理会社として適切に対応していた記録があるかどうかで状況が大きく変わります。

**物件の改善計画**——特定の部屋に苦情が集中していれば、遮音マットの設置や上下階の間取り配置の見直しなど、次の空室時にできる対策が見えてきます。
...
大家・管理会社に求められているのは完璧な防音ではなく、**「あなたの訴えを受け止めて、ちゃんと動いています」と伝え続けること**です。

Roomlyでは、問い合わせ・苦情を案件として登録し、対応履歴を時系列で記録できます。対応状況の追跡、担当者間の共有もひとつの画面で完結します。10区画まで無料なので、まずは試してみてください。[機能一覧はこちら](/features)。
